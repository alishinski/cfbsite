...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Game.num_code'
        db.alter_column(u'cfbdata_game', 'num_code', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Game.num_code'
        db.alter_column(u'cfbdata_game', 'num_code', self.gf('django.db.models.fields.IntegerField')())
