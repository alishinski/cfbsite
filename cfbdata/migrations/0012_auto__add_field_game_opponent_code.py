...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.opponent_code'
        db.add_column(u'cfbdata_game', 'opponent_code',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.opponent_code'
        db.delete_column(u'cfbdata_game', 'opponent_code')
