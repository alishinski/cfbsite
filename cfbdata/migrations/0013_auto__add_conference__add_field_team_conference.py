...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cfbdata_team', 'conference',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='conf', to=orm['cfbdata.Conference']),
                      keep_default=False)
    ...
    models = {
        ...
        u'cfbdata.team': {
            ...
            'conference': ('django.db.models.fields.related.ForeignKey', [], {'default': "'conf'", 'to': u"orm['cfbdata.Conference']"}),
            'conference_code': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
