...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Team.team_num_code'
        db.add_column(u'cfbdata_team', 'team_num_code',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.team_num_code'
        db.delete_column(u'cfbdata_team', 'team_num_code')
