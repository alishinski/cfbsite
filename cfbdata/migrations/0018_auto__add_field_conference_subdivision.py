...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conference.subdivision'
        db.add_column(u'cfbdata_conference', 'subdivision',
                      self.gf('django.db.models.fields.CharField')(default='FBS', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conference.subdivision'
        db.delete_column(u'cfbdata_conference', 'subdivision')
